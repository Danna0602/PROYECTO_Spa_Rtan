...
<div id="mainWrapper">
  <header> 
    ...
    <div id="logo"> <!-- <img src="logoImage.png" alt="sample logo"> --> 
      <!-- Company Logo text --><img src="imagenes/SPA3.jpg" width="74" height="50"></div>
    <div id="headerLinks"><a href="#" title="Login/Register">Login/Register</a><a href="#" title="Cart">Cart</a></div>
  </header>
  <section id="offer"> 
    <!-- The offer section displays a banner text for promotions -->
    <h2>&nbsp;</h2>
    <p><img src="imagenes/sPA2.jpg" width="620" height="130"></p>
    <p><em>ORFECTA 50%</em></p>
    <p><em>SOLO POR HOY ¡APROVECHA!</em></p>
  </section>
  <div id="content">
