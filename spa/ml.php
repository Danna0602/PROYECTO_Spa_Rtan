...
<div id="mainWrapper">
  <header> 
    ...
    <div id="logo"> <!-- <img src="logoImage.png" alt="sample logo"> --> 
      <!-- Company Logo text --> 
      <img width="124" height="53" ser=imagenes/logi></div>
    <div id="headerLinks"><a href="#" title="Login/Register">Login/Register</a><a href="#" title="Cart">Cart</a></div>
  </header>
  <section id="offer"><a href="imagenes/22.jpg"><img src="imagenes/22.jpg" width="612" height="160" title="OFFER 50%" align="absmiddle"></a>
  <div id="content">
